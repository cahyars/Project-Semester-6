...
<body>
    <h1>DATA KEGIATAN</h1>
    <br>
    <a href="<?= base_url('activity/user_activity') ?>">Aktivitas User</a>
    <br>
    <table border="1">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            foreach ($activities as $activity) { ?>
                <tr>
                    ...
                    <td>
                        <form action="<?= base_url(); ?>activity/status_update/<?= $activity->event_id ?>" method="POST">
                            <input type="hidden" name="status" value="approved">
                            <input type="hidden" name="approver" value="<?php echo $_SESSION['name']; ?>">
